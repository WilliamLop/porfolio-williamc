            ...
            <div className="flex justify-center relative mt-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    <h2 className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">
                        Magia Web dinámica con next.js
                    </h2>

                    <TextGenerateEffect
                        className='text-center text-[40px] md:text-5xl lg:text-6xl max-w-6xl'
                        words='Transformar conceptos en experiencias fluidas'
                    />

                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                        Hola, soy William Calderón, un desarrollador de Next.js con sede en Colombia.
                    </p>
                    <Link href="#about">
                        <MagicButton
